...
public class App extends JPanel {
  ...
  static void fahToCel() {
    float fah = Float.parseFloat(
      JOptionPane.showInputDialog("Enter a temperature in Fahrenheit")
    );
    JOptionPane.showMessageDialog(
      null,
      "The temperature " + fah + " in Celsius is " + fToC(fah)
    );
  }

  static void celToFah() {
    float cel = Float.parseFloat(
      JOptionPane.showInputDialog("Enter a temperature in Celcsius")
    );
    JOptionPane.showMessageDialog(
      null,
      "The temperature " + cel + " in Fahrenheit is " + cToF(cel)
    );
  }
